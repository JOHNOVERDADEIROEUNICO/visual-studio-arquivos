...
class Login : Cadastrar
{
    ...
    public void NewLogin()
    {
        ...
        //AO INVÉZ DE CRIAR UM ARRAY NO COMEÇO DA CLASSE, CRIAMOS DENTRO DO MÉTODO PASSANDO OS PARAMETROS NOME E SENHA COMO ELEMENTOS, ASSIM ELIMINANDO A NECESSIDADE DE CRIAR UM CLONE E EXCLUIR O ARRAY PARA EVITAR ERROS.
        public string[] register = new string[] { Nome, Senha }

        Usuarios.Add(register)

        //OUTRA DICA É USAR OS PARAMETROS DA CLASSE MÃE (O QUE MELHORA AINDA MAIS) QUE DEMONSTRAREMOS EM OUTRA PÁGINA DE CÓDIGO.
