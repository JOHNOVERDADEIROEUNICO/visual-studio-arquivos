...
namespace winformsfirst
{
    public partial class Form1 : Form
    {
        ...
        //Método da logica da calculadora:
        ...
        //Este método é acionado lá em cima no Form1() nele estão todos os componentes que foram criados na part1 e suas configurações(posição, cor, etc..)
